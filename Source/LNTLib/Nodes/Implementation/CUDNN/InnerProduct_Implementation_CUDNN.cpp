...
#include "InnerProduct_Implementation_CUDNN.h"
#include "../../InnerProduct.h"

using namespace LNTLib;

void InnerProduct_Implementation_CUDNN::Forward(const std::vector< ORUtils::MemoryBlock<float>* > &inputs)
{
	InnerProduct::NodeParams params = ((InnerProduct*)node)->Params();
...
void InnerProduct_Implementation_CUDNN::Allocate(LNTLib::Device *device)
{
...
void InnerProduct_Implementation_CUDNN::Deallocate()
{
...
void InnerProduct_Implementation_CUDNN::ReadWeights(FILE *f)
{
	InnerProduct::NodeParams params = ((InnerProduct*)node)->Params();
