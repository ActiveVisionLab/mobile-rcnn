...
typedef ORUtils::Image<Vector2ui> ORUInt2Image;
typedef ORUtils::Image<Vector3ui> ORUInt3Image;
typedef ORUtils::Image<Vector4ui> ORUInt4Image;
...
typedef ORUtils::Image<Vector3u> ORUChar3Image;
...
typedef ORUtils::TimeStampedImage<Vector4f> ORFloat4TSImage;
